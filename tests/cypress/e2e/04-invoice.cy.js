...
describe('Invoice Management', () => {
  ...
  it('should successfully create a complete invoice with client, items, and tax', () => {
    ...
    // This implicitly waits for the data to arrive
    ...
    cy.get('#number').clear().type(Math.floor(Math.random() * 10000).toString());
    cy.wait(300);
  ...
  it('should search/filter invoices by number or client', () => {
    cy.wait(1000);
